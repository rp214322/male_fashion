            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ asset('img/product/product-13.jp') }}g">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="{{ asset('img/icon/heart.png') }}" alt=""></a></li>
                                        {{-- <li><a href="#"><img src="img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li> --}}
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ asset('img/product/product-14.jp') }}g">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="{{ asset('img/icon/heart.png') }}" alt=""></a></li>
                                        {{-- <li><a href="#"><img src="img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li> --}}
